...
const ProfileScreen = () => {
    ...
    useEffect(() => {
    /** id = 1362951508036231170 */
    var username = "InigoJaque";
    var id = "1362951508036231170";
    var tweet = "https://api.twitter.com/2/users/" + id + "/tweets?max_results=100";
    
    //var user = "https://api.twitter.com/2/users/"+ id + "?user.fields=public_metrics,profile_image_url,description";
